...
{
    [Header("Input")] [Tooltip("exit inspecting the letter")] [SerializeField]
    private KeyCode exitInputAction;

    [Tooltip("Enter inspecting the letter in UI")] [SerializeField]
    private KeyCode interactInputAction;

    [Header("Text UI")] [SerializeField] [TextArea]
    ...
    [Tooltip("Optional image in bottom of the note")] [SerializeField]
